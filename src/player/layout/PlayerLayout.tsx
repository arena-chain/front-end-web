                            ...
                            >
                                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-emerald-600 p-[2px]">
                                    <div className="w-full h-full rounded-full bg-black flex items-center justify-center">
                                        <img
                                            src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${profile?.avatar || 'Felix'}`}
                                            alt="Player"
                                ...
                                <div className="hidden md:flex flex-col items-start">
                                    <span className="text-xs font-bold text-white leading-none">{profile?.nickname || 'Player One'}</span>
                                    <span className="text-[9px] bg-primary/20 text-primary px-1.5 py-0.5 rounded uppercase font-bold mt-0.5">{profile?.role || 'PRO'}</span>
                                </div>
                                ...
                                <>
                                    ...
                                    <div className="absolute right-0 top-full mt-2 w-52 bg-[#1A1D21] border border-white/10 rounded-xl shadow-2xl z-50 overflow-hidden">
                                        <div className="p-3 border-b border-white/5">
                                            <p className="text-sm font-bold text-white">{profile?.nickname || 'Player One'}</p>
                                            <p className="text-[11px] text-text-muted">{profile?.email || 'player.one@arena.com'}</p>
                                        </div>
                                        <div className="p-1.5">
