...
const TOP_NAV_LINKS = [
    { to: '/player/channel', label: 'Mon Arène', icon: <Video size={16} /> },
    { to: '/player/go-live', label: 'Go Live', icon: <Radio size={16} /> },
    { to: '/player/discovery', label: 'Découvrir', icon: <Users size={16} /> },
    { to: '/player/all-lives', label: 'Lives', icon: <Radio size={16} className="text-red-500" /> },
        ...
        <div className="h-screen bg-black p-3 flex overflow-hidden font-sans text-text">
            ...
            <div className="flex flex-col flex-1 bg-[#111214] rounded-3xl overflow-hidden">
                ...
                <header className="h-16 shrink-0 flex items-center z-30 border-b border-white/5 bg-[#060708]">
                    {/* Logo — sits above the icon sidebar */}
                    <div className="w-[68px] h-full flex items-center justify-center shrink-0 border-r border-white/5">
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <div className="hidden md:flex flex-col items-start">
                                        <span className="text-[11px] font-black text-white leading-none uppercase tracking-tighter italic">{profile?.nickname || "Chargement..."}</span>
                                        <div className="flex items-center gap-1.5 mt-1">
                                            <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                                            <span className="text-[9px] text-primary font-black uppercase tracking-widest leading-none">{profile?.role || "Player"}</span>
                                        </div>
                                    </div>
                                    ...
                                    <>
                                        ...
                                        <div className="absolute right-0 top-full mt-3 w-60 bg-[#0c0e11] border border-white/10 rounded-2xl shadow-2xl z-50 overflow-hidden backdrop-blur-3xl animate-in fade-in zoom-in duration-200">
                                            <div className="p-5 border-b border-white/5 bg-white/5">
                                                <p className="text-sm font-black text-white italic underline decoration-primary underline-offset-4">{profile?.nickname || "USER"}</p>
                                                <p className="text-[10px] text-white/40 font-bold tracking-wider mt-1 uppercase truncate">{profile?.email || "chargement..."}</p>
                                            </div>
                                            <div className="p-2">
                                                {[
