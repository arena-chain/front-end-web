                        ...
                        <div className="flex items-center gap-6">
                            <div className="hidden lg:flex items-center relative w-72 group">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/5 border border-white/5 rounded-2xl py-2.5 pl-11 pr-4 text-xs text-white placeholder:text-white/10 focus:outline-none focus:border-primary/40 focus:ring-4 focus:ring-primary/5 transition-all"
                                />
                            </div>

                            <button className="relative p-2.5 rounded-2xl border border-white/5 hover:border-white/20 text-white/30 hover:text-white transition-all">
                                <Bell size={18} />
                                <span className="absolute top-2 right-2 w-2 h-2 bg-primary rounded-full border-2 border-[#0a0c0f] shadow-[0_0_8px_rgba(0,255,135,0.8)]" />
                            </button>
