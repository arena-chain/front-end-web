...
import { Award, Clapperboard, Film, Gamepad2, History, LogOut, Sparkles, Ticket, Trophy, Users, Wallet, Zap } from 'lucide-react';
...
const PRIMARY_NAV_LINKS: { to: string; label: string; icon: LucideIcon }[] = [
    ...
    { to: '/player/trading', label: 'Trading', icon: Zap },
