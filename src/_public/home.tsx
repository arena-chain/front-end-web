    ...
    return (
        <div className="min-h-screen bg-background text-white selection:bg-primary selection:text-black">
            ...
            <main>
                ...
                {/* 4. Partners Section */}
                <section id="partners" className="min-h-screen flex flex-col justify-center py-24 bg-black relative overflow-hidden">
                ...
                {/* 6. Support Section */}
                <section id="support" className="min-h-screen flex flex-col justify-center py-24 relative">
                    <div className="container mx-auto px-6">
