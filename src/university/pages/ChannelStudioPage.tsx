    ...
    return (
        <div className="relative z-10 min-h-[calc(100dvh-4rem)] w-full scroll-smooth animate-fade-in selection:bg-primary/30 selection:text-white">
            <section className="relative w-full overflow-hidden bg-[#050608] shadow-[0_24px_80px_-24px_rgba(0,0,0,0.85)]">
                ...
                <div className="relative z-[10] w-full border-b border-white/[0.06] bg-[#050608] py-4 sm:py-5">
                    <div
                        role="toolbar"
                        ...
                        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4 lg:gap-6">
                            {studioVideos.map((v, idx) => (
                                <div
                                    ...
                                    className={`group/vod flex cursor-pointer flex-col overflow-hidden rounded-2xl border border-white/10 bg-[#0f1115] shadow-lg shadow-black/20 transition-all hover:border-primary/40 hover:shadow-[0_0_32px_rgba(0,255,135,0.12)] ${idx === 0 && studioVideos.length > 1 ? 'lg:col-span-2' : ''
                                        }`}
                                >
