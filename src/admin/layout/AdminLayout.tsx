        ...
        <div className="min-h-screen bg-background text-text flex font-sans">
            ...
            >
                ...
                <nav className="flex-1 py-6 px-3 space-y-1 overflow-y-auto">
                    ...
                    <NavItem to="/admin/leagues" icon={<Trophy size={20} />} label="League Hub" isOpen={isSidebarOpen} />
                    ...
                    <NavItem to="/admin/partnerships" icon={<Handshake size={20} />} label="Partnerships" isOpen={isSidebarOpen} />
