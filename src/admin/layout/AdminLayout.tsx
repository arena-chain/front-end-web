...
import {
    ...
    MessageSquare, Gamepad2, Gem, Layers,
    Box, Zap, ShieldCheck, Plus,
} from 'lucide-react';
...
const NAV_GROUPS = [
    {
        label: 'Tournaments',
        items: [
            { to: '/admin/tournaments', icon: Trophy, label: 'All Tournaments' },
            { to: '/admin/tournaments/create', icon: Plus, label: 'Create Tournament' },
            { to: '/admin/leagues', icon: Layers, label: 'Manage Brackets' },
            { to: '/admin/leagues/disputes', icon: MessageSquare, label: 'Reports & Disputes' },
        ],
    },
    {
        label: 'Users & XP',
        items: [
            { to: '/admin/users', icon: Users, label: 'Player Management' },
            { to: '/admin/xp', icon: Zap, label: 'XP & Leveling system' },
            { to: '/admin/bans', icon: ShieldCheck, label: 'Bans & Sanctions' },
        ],
    },
    {
        label: 'Analytics',
