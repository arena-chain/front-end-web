...
import { Gamepad2, ArrowLeft, Users, Shield, User, Binoculars, Loader2 } from 'lucide-react';
                            ...
                            <div className="space-y-2">
                                ...
                                {teamsLoading ? (
                                    ...
                                    <p className="text-sm text-amber-400/90">
                                        No teams found. Ask an administrator to create teams (Admin → leagues / teams), then refresh this page.
                                    </p>
                                ) : (
                                    <select
                                        name="teamId"
                                        ...
                                        onChange={handleChange}
                                        required
                                        className="w-full px-4 py-3 bg-surface border border-white/10 rounded-xl focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-all duration-200 text-white text-sm cursor-pointer"
                                    >
                                        {teams.map((t) => (
                                ...
                                <p className="text-[11px] text-text-muted">
                                    Lists all teams from the platform ({teams.length} available). Your request stays pending until an admin approves it.
                                </p>
                            </div>
                            <div className="space-y-2">
