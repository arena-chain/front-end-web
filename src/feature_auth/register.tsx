...
type UserRole = 'player' | 'team-manager' | 'referee';
            ...
            <div className="w-full max-w-2xl bg-surface/50 backdrop-blur-xl border border-white/10 p-8 rounded-2xl relative z-10 animate-fade-in-up shadow-2xl shadow-primary/5">
                ...
                <div className="grid grid-cols-3 gap-4 mb-8">
                    ...
                    <RoleCard
                        ...
                        onClick={() => setSelectedRole('team-manager')}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="pt-6">
                        <Button className="w-full" size="lg" isLoading={loading}>
                            Create {selectedRole === 'team-manager' ? 'Manager' : selectedRole.charAt(0).toUpperCase() + selectedRole.slice(1)} Account
                        </Button>
                    </div>
                </form>
